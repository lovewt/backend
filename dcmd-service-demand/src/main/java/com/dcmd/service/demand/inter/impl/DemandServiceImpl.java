...
//                }
    ...
    public String queryByMaxId(String name) throws Exception {
        ...
        //获取日期
        String num = RandomIdUtil.getLocalTrmSeqNum();
...
//                    return resData.toString();
                    return ResponseData.success().putDataValue(s1);
                }
                f.delete();
                if(file1.exists()){
                    file1.delete();
...
//                return resData.toString();
                return ResponseData.success().putDataValue(string);
            }
        }
//        resData.setStatus(false);
//        return resData.toString();
        return ResponseData.notFound().putDataValue("导入失败。。");
    }
